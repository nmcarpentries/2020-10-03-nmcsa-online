...
venue: "NM EPSCoR Supercomputing Challenge"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
...
helper: ["Jon Wheeler", "tbd"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
